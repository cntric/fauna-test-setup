...
import { FaunaTestDb, FaunaTestDbI, teardown } from "./faunaDatabases";
...
export const FolderHasItemTestSuiteA = ()=>{
    ...
    describe("Basic functionality", ()=>{
        ...
        test("Write to collection", async ()=>{
            ...
            const document : any = await client.query(Create(collectionName))

            const documentRetrieve = await client.query(Get(
                document["ref"]
            ))
